...
const getTimeToLikesAllBatches = async () => {
  try {
    const response = await requestApi(
      "https://tweetingantdb-9ezx.onrender.com/twitterClass/getTimeToLikesAllBatches",
      {
        method: "GET",
        headers: {
...
export default getTimeToLikesAllBatches;
