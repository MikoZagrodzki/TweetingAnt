...
const getTimeToRetweetsAllBatches = async () => {
  try {
    const response = await requestApi(
      "https://tweetingantdb-9ezx.onrender.com/twitterClass/getTimeToRetweetsAllBatches",
      {
        method: "GET",
        headers: {
...
export default getTimeToRetweetsAllBatches;
