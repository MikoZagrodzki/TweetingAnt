import { updatePersonality, deleteTimeToCommentsSpecific, deleteTimeToLikesSpecific, deleteTimeToRetweetsSpecific, deleteTimeToTweetsSpecific, deleteUserContentSpecific, deleteUserNameUsedForTweetsSpecific, insertUserContent, insertUserNameUsedForTweets, updateCommentsIntensivity, updateIsAutomated, updateLikesIntensivity, updateRetweetsIntensivity, updateTimeToCommentsSpecific, updateTimeToLikesSpecific, updateTimeToRetweetsSpecific, updateTimeToTweetsSpecific, updateTweetsIntensivity } from "./SQL";
