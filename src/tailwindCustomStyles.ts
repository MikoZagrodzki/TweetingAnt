...
export const BUTTON_STYLING =classnames('text-xs sm:text-sm whitespace-nowrap bg-secondary font-semibold px-1 rounded-full border border-accent hover:bg-accent hover:text-white hover:border-primary shadow-md')
export const INFO_TEXT = classnames('text-xs md:text-sm whitespace-nowrap');
export const TWEET_TEXT = classnames('text-xs sm:text-sm');
export const BORDER_STYLING = classnames('border border-2 border-secondary');
